...
create_operating_condition op_cond_fast
create_operating_condition op_cond_slow
add_opc_supplies op_cond_typ D_VDD 3.3
add_opc_grounds op_cond_typ D_GND 0
set_opc_temperature op_cond_typ 25
add_opc_supplies op_cond_fast D_VDD 3.3
add_opc_grounds op_cond_fast D_GND 0
set_opc_temperature op_cond_fast 25
add_opc_supplies op_cond_slow D_VDD 3.3
add_opc_grounds op_cond_slow D_GND 0
set_opc_temperature op_cond_slow 25
set_opc_process op_cond_typ [subst {
	{ .lib "./process/mos.lib" typ }
	{ .lib "./process/res.lib" typ }
	{ .lib "./process/cap.lib" typ }
}]
set_opc_process op_cond_fast [subst {
    { .lib "./process/mos.lib" wcp }
    { .lib "./process/res.lib" min }
    { .lib "./process/cap.lib" min }
}]
set_opc_process op_cond_slow [subst {
    { .lib "./process/mos.lib" wc0 }
    { .lib "./process/res.lib" max }
    { .lib "./process/cap.lib" max }
}]
...
define_parameters default {
    ...
    # List of operating conditions as defined by create_operation_condition
     set active_pvts { op_cond_typ op_cond_fast op_cond_slow }
    ...
    set gate_leakage_time_scaling_factor 5
...
pintype default {
    ...
    set numsteps_slew 12
    set numsteps_load 12

    #set explicit_points_slew {0.01e-9 0.1e-9 0.2e-9 0.3e-9 0.4e-9 0.5e-9 0.6e-9 0.7e-9 1.5e-9 3e-9}

    #set explicit_points_load {0.001e-12 0.03e-12 0.04e-12 0.05e-12 0.06e-12 0.07e-12 0.08e-12 0.1e-12 0.15e-12 0.3e-12}
    # Operating load ranges
    set smallest_load 0.01e-15
    ...
    set smallest_slew 0.01e-9
    set largest_slew 8.5e-09
    #set max_tout 10e-09
    #
    ...
    set autorange_load_minmax_ratio 3
