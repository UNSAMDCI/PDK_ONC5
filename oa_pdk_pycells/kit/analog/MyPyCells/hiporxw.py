...
class hiporxw(DloGen):
    ...
    #--------------------------------------------------------------------------------------------
        ...
        resLayer    = tech.getLayer('POLY2')    

        #machiar el pdk  tech.getPhysicalRule('minWidth', resLayer)
        specs('model','hiporxwnl','model name',ChoiceConstraint(['hiporxw','hiporxwnl']))
    ...
    #--------------------------------------------------------------------------------------------
        ...
        self.minExtP2 = self.tech.getPhysicalRule('minExtension',self.resType,self.resLayer)
    ...
    #--------------------------------------------------------------------------------------------
        ...
        hiresBox = resistorStack.getBBox(Layer('RES'))
        ...
        hiresRect = Rect(self.resType,hiresBox)


        if self.shield == 'Ntype':
            dummy1Box = self.Units[0].getBBox(self.metLayer).expand(0.6)
            dummy1Rect = Rect(self.metLayer,dummy1Box) 
